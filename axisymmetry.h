...
#ifndef axisymmetry_H
#define axisymmetry_H

class Axisymmetry;

#include "guiwsitem.h"
#include "ui_axisymmetryconfig.h"

//#include <vtkRotationFilter.h>

class Axisymmetry : public GuiWsItem<Ui::AxisymmetryConfig>
{
...
private:
  ...
  //vtkRotationFilter   *vtk;

public:

  Axisymmetry (WorkSpace *ws);
  ~Axisymmetry();
